#!/usr/bin/env python3
"""Add a fixed +Y side-view cloud to every completed processed instance."""
...
from tomato_recon.data.side import SideSettings, generate_side_dataset
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        ...
        report = generate_side_dataset(args.processed_root, settings, progress=print_progress)
